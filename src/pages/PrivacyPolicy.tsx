...
export default function PrivacyPolicy() {
  return (
    <LegalShell title="Política de Privacidade">
      <section>
        <h2 className="font-display text-xl font-bold text-white">1. Dados coletados</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="font-display text-xl font-bold text-white">2. Finalidade e base legal (LGPD)</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="font-display text-xl font-bold text-white">4. Seus direitos</h2>
        <p className="mt-2">
