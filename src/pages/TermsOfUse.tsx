...
export default function TermsOfUse() {
  return (
    <LegalShell title="Termos de Uso">
      <section>
        <h2 className="font-display text-xl font-bold text-white">1. Sobre a loja</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="font-display text-xl font-bold text-white">2. Prazo de entrega</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="font-display text-xl font-bold text-white">3. Trocas e devoluções</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="font-display text-xl font-bold text-white">4. Pagamento</h2>
        <p className="mt-2">
